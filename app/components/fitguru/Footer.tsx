    ...
    <footer id="footer" className="section footer">
      ...
      <div className="container footer__cols">
        <div className="footer__brand">
          <a className="logo logo--dark" href="#hero">
          ...
          <div className="footer__socials">
            <a href="#" aria-label="Facebook">
              <svg width="9" height="18" viewBox="0 0 9 19" fill="none">
                <path d="M9 6.3H6.6V4.7c0-.6.4-.8 1-.8h1.9V.1L6.6.1C3.9.1 3 1.5 3 3.8V6.3H1v3.7h2V19h3.6V10h2.4L9 6.3z" fill="#111" />
              </svg>
            </a>
            ...
            <a href="#" aria-label="Instagram">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                <rect x="1" y="1" width="16" height="16" rx="4.5" stroke="#111" strokeWidth="1.6" />
                <circle cx="9" cy="9" r="4" stroke="#111" strokeWidth="1.6" />
                <circle cx="13.6" cy="4.4" r="1" fill="#111" />
              </svg>
            </a>
          </div>
        </div>
